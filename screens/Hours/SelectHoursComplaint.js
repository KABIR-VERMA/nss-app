      ...
      return (
        ...
        >
          ...
          <HoursButton
            ...
            bRadius={width / 3}
            txt={"CHECK\nHOURS"}
            msg={"Hours has been Pressed"}
            icon={faSearch}
            handlePress={this.handlePressCheck}
          />
          <HoursButton
            width={width / 2}
            height={width / 2}
            ...
            bRadius={width / 3}
            txt={"HOURS\nCOMPLAINT"}
            msg={"Complaint has been Pressed"}
            icon={faExclamationTriangle}
            handlePress={this.handlePressComplaint}
          />
        </View>
      );
    else if (this.state.mode == "check")
      return <CheckHours handlePressBack={this.handlePressBack} />;
    else return <Complaint handlePressBack={this.handlePressBack} />;
  };
