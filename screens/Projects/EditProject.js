...
class EditProjectScreen extends React.Component {
    constructor(props) {
        ...
        this.state = {
            imageArray:this.imageArray==undefined?[]:this.imageArray,
            membersPicked: [],
            designationArr: [],
            category: this.category,
            title:this.title,
            iconUrl:this.iconUrl==undefined?"":this.iconUrl,
            description:""
        };
      }
  ...
  componentDidMount = () => {
    ...
    let query = firebase
      ...
      if(this.props.navigation.state.params !=undefined){
        ...
        // console.log(params)
        this.setState({params,title:params.title,iconUrl:params.iconUrl,description:params.description,address:params.address,membersPicked:params.members})
        this.forceUpdate();
    }
  };
            ...
            [
              ...
              },
              {
                ...
                onPress: () => {
                  ...
                  firebase.firestore().collection("Projects").where("title","==",this.state.title).get()
